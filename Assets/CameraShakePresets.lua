...
local CameraShakePresets = {
	...
	SmallExplosion = function()
		local c = CameraShakeInstance.new(2, 2, 0, 1.5)
	...
	BigExplosion = function()
		local c = CameraShakeInstance.new(20, 10, 0, 2)
		c.PositionInfluence = Vector3.new(2,2,2)
		c.RotationInfluence = Vector3.new(0,0,0)
		return c
	end;
	
	BigContinueousExplosion = function()
		local c = CameraShakeInstance.new(10, 15, 2, 5)
		c.PositionInfluence = Vector3.new(1,1,1)
